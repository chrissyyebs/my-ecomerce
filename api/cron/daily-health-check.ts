...
import { getLowStockProducts, getStuckOrders } from '../../backend/services/analytics.service.js';
import { notifyLowStock, notifyStuckOrders } from '../../backend/services/telegram.service.js';
...
export default async function handler(req: Request, res: Response): Promise<void> {
  ...
  // --- Stuck Order Check ---
  try {
    // Use a longer threshold (24 hours) since this now runs daily instead of every 30 min
