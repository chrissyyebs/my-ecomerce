                  ...
                  {cart.map((item) => (
                    <div key={`co-${item.id}`} className="flex items-center gap-3 bg-surface-subtle rounded-lg p-2">
                      ...
                      <span className="text-xs font-semibold text-primary flex-shrink-0">
                        GH₵{(item.price * item.quantity).toLocaleString('en-US', { minimumFractionDigits: 2 })}
                      </span>
                    </div>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <span className="text-[10px] text-on-surface-muted">GH₵15.00 • 3-5 days</span>
                  </button>
                  <button
                    type="button"
            ...
            <div className="sticky bottom-0 bg-surface border-t border-border p-4 space-y-3">
              <div className="space-y-1 text-xs">
                <div className="flex justify-between text-on-surface-muted">
                  <span>Subtotal</span>
                  <span>GH₵{subtotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
                </div>
                <div className="flex justify-between text-on-surface-muted">
                  <span>Delivery</span>
                ...
                <div className="flex justify-between text-on-surface font-bold text-sm pt-1 border-t border-border/60">
                  <span>Total</span>
                  <span className="text-primary">GH₵{grandTotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
                </div>
              </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
            ...
            <div className="w-full bg-surface-subtle p-3 rounded-lg border border-border text-left mt-5 space-y-1.5 text-xs">
              ...
              <div className="flex justify-between text-on-surface-muted pt-1 border-t border-border/60">
                <span>Total</span>
                <span className="font-bold text-primary">GH₵{grandTotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
              </div>
            </div>
